...
{
    public class GetOrderHistoryByIdQueryHandler : IRequestHandler<GetAllOrderHistoryQuery, List<OrderOrderDetailsSellerProductDto>>
    {
        private readonly InventoryManagementContext _context;

        public GetOrderHistoryByIdQueryHandler(InventoryManagementContext context)
        {
            _context = context;
        }
            ...
            var re = await Task.Run(() =>
            {
                ...
                foreach (var order in orders)
                {
                    ...
                    foreach (var item in order.OrderDetails)
                    {
                        ...
                        obj.ProductName = item.SellerProduct.ProductName;
                    }
